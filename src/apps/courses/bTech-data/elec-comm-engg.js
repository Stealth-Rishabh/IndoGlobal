            ...
            content: [
                {
                    ...
                    data: {
                        ...
                        answer: "Graduates have opportunities in telecommunications, embedded systems, semiconductor industry, and research organizations."
                    }
                },
                {
                    label: "FAQ 2",
                    data: {
                        ...
                        answer: "Yes, the college provides internship opportunities with leading tech companies and research institutions."
                    }
                }
            ]
        },
            ...
            content: [
                {
                    ...
                    data: {
                        name: "Rajesh Kumar",
                        rating: 5,
                        comment: "Excellent program with comprehensive coverage of modern communication technologies."
                    }
                },
                {
                    label: "Review 2",
                    data: {
                        name: "Priya Sharma",
                        rating: 4,
                        comment: "Great practical exposure and industry-relevant curriculum."
                    }
                }
            ]
        }
