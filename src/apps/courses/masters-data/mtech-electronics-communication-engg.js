    ...
    tabs: [
      {
        ...
        content: [
          ...
          },
          {
            type: "paragraph",
            data:
              "The aim of the program is to give a broad theoretical knowledge imbued with deep research and understanding. This approach will enable students to tackle complex issues of design and development in industrial fields and to deep dive into the research areas of their interest. M.Tech Electronics and Communication at Indo Global College is very comprehensive and in line with the latest market trends and academia.",
          },
          {
            type: "paragraph",
            data:
              "The program is aimed to provide students with a wide range of opportunities, both in the industry as well as in R&D fields. The curriculum is designed to make the students excel in different areas like antenna theory, advanced embedded systems, modern DSP, error control and coding, along with elective courses like CMOS VLSI design, wireless and mobile networks, and real-time operating systems. The students have the option to select various other subjects as per their interest. Students also get the opportunity to work on projects in different industries.",
          },
          {
            type: "heading",
          ...
          },
          {
            ...
            data: [
              ...
              "Syllabus designed in line with the best available schemes and compared with top universities like IIT, NIT, UGC, etc.",
              ...
              "Industry-oriented program with projects, dissertation, and training in industry",
              "Laboratory teaching learning",
            ],
          },
          {
            type: "paragraph",
            data:
              "Our M.Tech ECE program helps in the overall development of the candidate in various aspects desired for a successful career ahead.",
          },
          {
            type: "heading",
          ...
          },
          {
            type: "list",
            data: [
              "Helpful in starting a career in various sectors like banking, business, agriculture, railways, forensic, health and medicine, police, wireless industry, education sector, etc.",
              ...
              "Increased demand by government and private sectors, many businesses for electronics and communication equipment along with the rise in consumer demand and other types of automation has opened up vast employment opportunities in this sector.",
            ],
          },
          {
            type: "heading",
          ...
          },
          {
            type: "paragraph",
            data:
              "Latest computer systems with software like Matlab, Commsim, Multisim, Keil, Xilinx, and Ultiboard are available for students for their hands-on training and job experience with the latest emerging technology in this branch.",
          },
          {
            type: "sub-heading",
          ...
          },
          {
            type: "paragraph",
            data:
              "Equipped with microprocessor kits of 8085, 8086, and microcontrollers such as 8051, 8951. Complete digital electronics kits such as Multiplexer, ALU, and gates are available for training along with PC and project labs.",
          },
          {
            type: "sub-heading",
          ...
          },
          {
            type: "paragraph",
            data:
              "The Communication lab is well equipped with the latest measurement and communication devices including function generators, super heterodyne receivers, CROs, audio oscillators, and high-frequency generators. PCM Multiplexing and Demultiplexing kits are also available. For Digital Communication, the department has ASK, PSK, FSK, and Delta Modulation Kits.",
          },
          {
            type: "sub-heading",
            data: "Microwave Lab",
          },
          {
            type: "paragraph",
            data:
              "Sophisticated devices like advanced antennas are present in this lab. Other instruments include reflex klystrons, Gunn diodes, wave-guides, flanges, attenuators, frequency meters, slotted sections, probes, circulators, and tees.",
          },
          {
            type: "sub-heading",
          ...
          },
          {
            type: "paragraph",
            data:
              "Equipment for basics of instrumentation such as Kelvin Bridge, Wheatstone bridge, Kelvin Double Bridge are available. For process and control applications, the department has PID controllers, compensators, AC and DC motor controllers, and AC and DC error controllers.",
          },
          {
            type: "sub-heading",
          ...
          },
          {
            type: "paragraph",
            data:
              "This lab has kits relating to passive filters such as Low Pass, High Pass, Band Pass, Band Stop, Constant-K, m-derived, and composite filters. It also has kits for study and analysis of basic active components such as h-parameter study kits for transistors, CB, CC, and CE configurations of BJT, biasing circuits for FET and MOSFET, and OP-Amp applications.",
          },
          {
            type: "sub-heading",
            data: "Project Lab",
          },
          {
            type: "paragraph",
            data:
              "The department boasts a PCB lab for students to build their own projects. The lab has all the equipment needed for PCB manufacturing such as positive-negative generator, etching machine, cutting machine, drilling machine, tinner, and UV exposure unit. It also has 20 computers with design software, function generators, and CROs for checking designs.",
          },
        ],
      },
      {
        ...
        content: [
          ...
          },
          {
            type: "paragraph",
            data:
              "The eligibility criterion for admission to AICTE approved M.Tech (Full time/Part Time) course is a regular B.E/B.Tech. with at least 50% marks (45% marks in case of candidates belonging to reserved categories) in aggregate and a valid GATE Score. In case candidates with a valid GATE Score are not available, the seats shall be filled on the basis of inter-se-merit in the qualifying examination.",
          },
        ],
      },
      {
