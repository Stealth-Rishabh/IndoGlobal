...
const features = [
  {
    ...
    description: "Build effective communication and collaboration abilities crucial for workplace success through interactive workshops and team projects.",
    icon: <Users/>,
  },
  {
    title: "PowerPoint Presentations",
    description: "Gain proficiency in digital tools and public speaking through guided presentation workshops and practice sessions.",
    icon: <Laptop/>,
  },
  {
    title: "Entrepreneurship Classes",
    description: "Learn essential skills for starting and running a business, including business planning, financial literacy, and market analysis.",
    icon: <Lightbulb/>,
  },
  {
    title: "Entrepreneurial Clubs",
    description: "Join clubs that connect you with successful entrepreneurs and investors through networking events and mentorship sessions.",
    icon: <Network/>,
  }
]
const cards = [
	...
	return (
		<section className="rounded-lg dark-gray    dark:bg-[#0b1727] text-slate-800 dark:text-white">
            ...
            <p className="text-lg leading-6 mb-6 text-gray-500">
              Join us to explore the latest placement highlights and success stories.
            </p>
					</div>
					{cards.map((item, i) => (
						<div className="col-span-3 md:col-span-1 hover:scale-105 duration-300" key={i}>
							<CardItem item={item} />
						</div>
					))}
				</div>
	...
	return (
		<section className="ezy__featured5 light py-6 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative overflow-hidden z-[1]">
            ...
            Skills Development and Entrepreneurship
						...
						<p className="text-lg leading-6 mb-6 text-gray-500">
            We offer a wide range of programs that help students develop their skills and entrepreneurship skills.
						</p>
					</div>
				</div>
