    ...
    <div className="min-h-screen  ">
      <Card className="mx-auto max-w-3xl rounded-none sm:rounded-lg">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className=" text-2xl sm:text-3xl">University Job Application</CardTitle>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  ...
                  <Input id="address" name="address" placeholder="123 University Ave, City, State" required />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <RadioGroup name="positionType" className="grid grid-cols-2 md:grid-cols-4 gap-4" defaultValue="teaching">
