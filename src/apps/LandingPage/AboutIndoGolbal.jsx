      ...
      <Container className="container mx-auto lg:pt-60 pt-10 ">
        <div className="flex sm:flex-col flex-col-reverse md:flex-row gap-14 md:gap-28">
          ...
          <div className="w-full md:w-1/2 md:pl space-y-6 relative">
            <div className="w-fit top-0 mx-auto sm:mx-0 bg-red-600 text-white text-2xl px-4 py-1 ">
              About
            </div>
            <h2 className="text-center sm:text-left text-4xl md:text-6xl font-semibold sm:font-bold text-blue-800 mt-8 mb-4">Indo Global</h2>
