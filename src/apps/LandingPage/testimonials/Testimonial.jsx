...
export function Testimonials() {
  ...
  return (
    <Container className="grid grid-cols-1 gap-20 md:grid-cols-2">
      <div className="relative h-[600px] flex w-full flex-col items-center justify-center rounded-lg">
      ...
      <div className="h-full w-full">
        <Heading
          ...
          titleClassName="lg:font-extrabold lg:text-left font-bold text-secondary-color rem]"
          className="w-full sm:col-span-4 pb-0 text-left sm:pb-0 lg:pb-14"
        />
              ...
              <CarouselItem key={testimonial.id}>
                <div className="p-1">
                  <Card className="bg-transparent border-none rounded-none shadow-none">
                    <CardContent className="p-0 lg sm:h-[350px] border-none shadow-none grid">
                      <div className="bg-white">
                        <div className="p-0 space-y-8">
                          ...
                          <blockquote className="md:text-3xl text-xl font-medium text-gray-700 mb-4 leading-[3rem]">
                            {testimonial.quote}
                          </blockquote>
                          <div className="mt-6">
                            <p className="md:text-2xl text-lg font-semibold text-red-600">
                              {testimonial.name}
                            </p>
